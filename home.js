...
function replay()
{
    const newnode= document.getElementById("flex-box-rps-div");
    newnode.innerHTML = '';
    // document.querySelector('div img#user').remove();
    // document.querySelector('div h1#heading').remove();
    // document.querySelector('div img#comp').remove();
    ...
    // stylee.innerHTML = "<style> #flex-box-rps-div {display: flex;border: 1px solid black;padding: 10px; flex-wrap: wrap;flex-direction: row; justify-content: space-around;}</style>";
    // document.getElementById('flex-box-rps-div').appendChild(stylee);
